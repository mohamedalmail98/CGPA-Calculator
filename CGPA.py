...
st.sidebar.markdown(
    ...
    <hr style="border: 0; height: 2px; background: #DDD; margin: 30px 0 10px 0;">
    """,
...
st.sidebar.markdown(
    ...
    <div style="font-family:sans-serif; line-height:1.4; padding-left:5px; margin-top:20px;">
        ...
        <ul style="list-style:none; padding-left:0; margin-top:0; margin-bottom:0; font-size:14px;">
            ...
            <li style="margin-bottom:12px;"><b>3.30 - 3.69</b>: Very Good</li>
            <li style="margin-bottom:12px;"><b>3.00 - 3.29</b>: Good</li>
            <li style="margin-bottom:12px;"><b>Below 3.00</b>: Fail</li>
        </ul>
    </div>
    """,
    unsafe_allow_html=True,
